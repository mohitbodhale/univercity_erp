  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <?php
          echo $this->Form->control('Transaction Type', ['options' => array('Inward'=>'Inward','Outward'=>'Outward'), 'empty' => "Select Type"]);
        ?> 
        </div>
        <div class="box-header">
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                  ...
                  <th scope="col"><?= $this->Paginator->sort('warehouses_id') ?></th>
            ...
            <tbody>
              <?php foreach ($orders as $order): ?>
                <tr>
                  ...
                  <td><?= $this->Number->format($order->customers_id) ?></td>
                  <td><?= $this->Number->format($order->warehouses_id) ?></td>
